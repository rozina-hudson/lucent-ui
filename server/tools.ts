...
export function registerTools(server: McpServer): void {
  ...
  server.tool(
    ...
    {},
    withLogging('list_components', async () => {
  ...
  server.tool(
    ...
    withLogging('get_component_manifest', async ({ componentName }) => {
  ...
  server.tool(
    ...
    withLogging('search_components', async ({ query }) => {
  ...
  server.tool(
    ...
    {},
    withLogging('list_presets', async () => {
      return {
        content: [
          {
            type: 'text' as const,
